...
#define UI_MENU_SD {UI_MENU_ADDCONDBACK &ui_menu_sd_printfile,&ui_menu_sd_pause,&ui_menu_sd_continue,&ui_menu_home_all,&ui_menu_home_z,&ui_menu_quick_stopstepper,&ui_menu_sd_unmount,&ui_menu_sd_mount,&ui_menu_sd_delete}
UI_MENU(ui_menu_sd,UI_MENU_SD,9+UI_MENU_BACKCNT);
